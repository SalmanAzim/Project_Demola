...
app.controller('MyController', function ($scope, socket ,$window, $timeout) {
	...
	$scope.phase1 = {
		...
		location: "phase1",
		time: d.getTime(),
		productList: ['prod1', 'prod12', 'prod897'],
		status: true,
		productNos: 3
	};
	...
	$scope.phase2 = {
		...
		location: "phase2",
		time: d.getTime(),
		productList: ['prod6', 'prod78', 'prod87', 'prod19', 'prod7'],
		status: true,
		productNos: 5
	};
	...
	/*(function update() {
		...
		$scope.phase2.time = d.getTime();
		$scope.phase1.time = d.getTime();
		if ((Math.random() * 10) > 5) {
			$scope.phase1.status = true;
			$scope.phase2.status = false;
		} else {
			$scope.phase2.status = true;
